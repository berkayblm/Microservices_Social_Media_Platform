package com.micro_project.messagingservice.userservice.service;
...
import com.micro_project.messagingservice.userservice.repository.UserRepository;
...
public class UserService {
    ...
    public List<User> getRandomUsersExcludingIds(List<Long> excludeIds, int limit) {
        if (excludeIds == null || excludeIds.isEmpty()) {
            return userRepository.findRandomUsers(limit);
        }
        return userRepository.findRandomUsersExcludingIds(excludeIds, limit);
    }
}
